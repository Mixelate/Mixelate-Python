...
from modals.addcharge import AddCharge
...
class CommissionTicket(discord.ui.View):
    ...
    @discord.ui.button(emoji='👋', label='Leave', style=discord.ButtonStyle.gray, custom_id='c_ticket:1')
    ...
    @discord.ui.button(emoji='🔁', label='Repost', style=discord.ButtonStyle.gray, custom_id='c_ticket:2')
...
""",
    ...
    @discord.ui.button(emoji='💰', label='Add Charge', style=discord.ButtonStyle.gray, custom_id='c_ticket:3')
    async def addcharge(self, interaction: discord.Interaction, button: discord.ui.Button):
            await interaction.response.send_modal(AddCharge())

    @discord.ui.button(emoji='🤝', label='Invite', style=discord.ButtonStyle.gray, custom_id='c_ticket:4', row=2)
    ...
    @discord.ui.button(emoji='📰', label='Transcript', style=discord.ButtonStyle.gray, custom_id='c_ticket:5', row=2)
...
""")
    ...
    @discord.ui.button(emoji='🔒', label='Close', style=discord.ButtonStyle.gray, custom_id='c_ticket:6', row=2)
...
""")
            with open("transcripts.html", "rb") as file:
                ...
                hours, remainder = divmod(math, 3600)
...
class ApplicationTicket(discord.ui.View):
    def __init__(self, bot):
        super().__init__(timeout=None)
        self.bot = bot
    
    @discord.ui.button(emoji='🤝', label='Invite', style=discord.ButtonStyle.gray, custom_id='a_ticket:1', row=1)
    async def invite(self, interaction: discord.Interaction, button: discord.ui.Button):
        view = InviteDropdownView()
        embed = discord.Embed(description="Select a member down below to invite!", color=discord.Color.from_str(embed_color))
        await interaction.response.edit_message(content=None, embed=embed, view=view)

    @discord.ui.button(emoji='📰', label='Transcript', style=discord.ButtonStyle.gray, custom_id='a_ticket:2', row=1)
    async def transcript(self, interaction: discord.Interaction, button: discord.ui.Button):
        with open("transcripts.html", "w", encoding="utf-8") as file:
            msg = [message async for message in interaction.channel.history(oldest_first=True, limit=1)]
            firstmessagetime = msg[0].created_at.strftime("%m/%d/%y, %I:%M %p")
...
""")
    ...
    @discord.ui.button(emoji='🔒', label='Close', style=discord.ButtonStyle.gray, custom_id='a_ticket:3', row=1)
    async def close(self, interaction: discord.Interaction, button: discord.ui.Button):
            db = await aiosqlite.connect('database.db')
            try:
...
class SupportTicket(discord.ui.View):
    ...
    @discord.ui.button(emoji='🤝', label='Invite', style=discord.ButtonStyle.gray, custom_id='s_ticket:1', row=1)
    async def invite(self, interaction: discord.Interaction, button: discord.ui.Button):
        view = InviteDropdownView()
        embed = discord.Embed(description="Select a member down below to invite!", color=discord.Color.from_str(embed_color))
        await interaction.response.edit_message(content=None, embed=embed, view=view)

    @discord.ui.button(emoji='📰', label='Transcript', style=discord.ButtonStyle.gray, custom_id='s_ticket:2', row=1)
    async def transcript(self, interaction: discord.Interaction, button: discord.ui.Button):
        with open("transcripts.html", "w", encoding="utf-8") as file:
            msg = [message async for message in interaction.channel.history(oldest_first=True, limit=1)]
            firstmessagetime = msg[0].created_at.strftime("%m/%d/%y, %I:%M %p")
...
""")
    ...
    @discord.ui.button(emoji='🔒', label='Close', style=discord.ButtonStyle.gray, custom_id='s_ticket:3', row=1)
    async def close(self, interaction: discord.Interaction, button: discord.ui.Button):
            db = await aiosqlite.connect('database.db')
