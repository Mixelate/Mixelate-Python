...
class Wallet(discord.ui.View):
    ...
    @discord.ui.button(emoji='🤝', label='Spendings', style=discord.ButtonStyle.gray, custom_id='wallet:2')
    ...
    @discord.ui.button(emoji='💵', label='Balance', style=discord.ButtonStyle.gray, custom_id='wallet:3')
    ...
    @discord.ui.button(emoji='🤑', label='Withdraw', style=discord.ButtonStyle.gray, custom_id='wallet:4')
    async def withdraw(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_modal(WalletWithdraw())

    @discord.ui.button(emoji='🧮', label='Calculator', style=discord.ButtonStyle.gray, custom_id='wallet:5')
