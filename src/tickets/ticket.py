...
""",
                                ...
                                await interaction.channel.send(embed=embed)
                                embed = discord.Embed(description=f"Please leave a rating for {freelancer.mention}! \n\n*Note: Reviews are publicly displayed*", color=discord.Color.from_str(embed_color))
                                await interaction.channel.send(embed=embed, view=ReviewSystem())
                                if b[8] != 'null':
                                    embed = discord.Embed(description=f"If you would like to leave a tip for {freelancer.mention}, you may do so below. \n\n100% of the tip goes directly to the freelancer.", color=discord.Color.from_str(embed_color))
                                    tiplink = b[8]
